...
public class SignUpRetailer extends AppCompatActivity {
    ...
    public void callNextSigupScreen(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), SignUpRetailer2ndClass.class);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(SignUpRetailer.this, pairs);
